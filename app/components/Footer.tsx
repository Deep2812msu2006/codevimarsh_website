    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Code Vimarsh</h3>
            <p className="text-gray-400">
              Empowering developers through knowledge sharing and collaboration.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-white">Upcoming Events</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white">Past Events</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white">Workshops</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white">Hackathons</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mt-2">Email: info@codevimarsh.com</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Code Vimarsh. All rights reserved.</p>
